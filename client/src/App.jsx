    ...
    <div className="auth-shell safety-notice-shell">
      <div className="auth-card safety-notice-card">
        ...
        <div className="auth-heading">
          ...
          <p>
            Jejak Saku is for personal finance records, spending reports, receipt history, and analysis.
...
function OfflineNotice() {
  ...
  return (
    <div className="offline-notice" role="status">
      You are offline. Jejak Saku will keep the app open, but fresh account data and uploads need a connection.
    </div>
  );
}
    ...
    <main className="auth-shell">
      <section className="auth-card compact">
        ...
        <div className="auth-heading">
          ...
          <p>You can now log in to Jejak Saku with your email and password.</p>
        </div>
    ...
    return (
      <div className="auth-shell">
        <div className="auth-card compact">
          <BrandMark />
          <p>Checking your Jejak Saku session...</p>
        </div>
      </div>
    );
  }
